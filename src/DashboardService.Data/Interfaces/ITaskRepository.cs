...
public interface ITaskRepository
{
  ...
  Task<(List<DbTask> dbTasks, int totalCount)> GetAllAsync(GetTasksFilter filter, CancellationToken cancellationToken);
  Task<DbTask> GetAsync(Guid id, GetTaskFilter filter, CancellationToken cancellationToken = default);
